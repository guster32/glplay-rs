...
bitflags! {
    ...
    pub struct BufferObjectFlags: u32 {
        ...
        const SCANOUT      = ::ffi::GBM_BO_USE_SCANOUT as u32;
        /// Buffer is going to be used as cursor
        const CURSOR       = ::ffi::GBM_BO_USE_CURSOR as u32;
        /// Buffer is going to be used as cursor (deprecated)
        #[deprecated = "Use CURSOR instead"]
        const CURSOR_64X64 = ::ffi::GBM_BO_USE_CURSOR_64X64 as u32;
        /// Buffer is to be used for rendering - for example it is going to be used
        /// as the storage for a color buffer
        const RENDERING    = ::ffi::GBM_BO_USE_RENDERING as u32;
        ...
        const WRITE        = ::ffi::GBM_BO_USE_WRITE as u32;
        /// Buffer is linear, i.e. not tiled.
        const LINEAR       = ::ffi::GBM_BO_USE_LINEAR as u32;
        /// Buffer is protected
        const PROTECTED    = ::ffi::GBM_BO_USE_PROTECTED as u32;
    }
}
        ...
        unsafe {
            ...
            let ptr = ::ffi::gbm_bo_map(
                *self.ffi,
                ...
                width,
                height,
                ::ffi::GBM_BO_TRANSFER_READ as u32,
                &mut stride as *mut _,
                &mut data as *mut _,
            );
        ...
        unsafe {
            ...
            let ptr = ::ffi::gbm_bo_map(
                *self.ffi,
                ...
                width,
                height,
                ::ffi::GBM_BO_TRANSFER_READ_WRITE as u32,
                &mut stride as *mut _,
                &mut data as *mut _,
            );
